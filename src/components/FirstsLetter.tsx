...
export default function FirstsLetter() {
  ...
  return (
    <>
        {theme && <div className="alphabet text-center w-70cqw mx-auto">
            <div className="alhabet-tittle font-frederica space-x-24 text-2xl pt-5">
            <h1 className='py-5'>Find Name Of Drink By First Letter</h1>
            </div>
        ...
        {!theme && <div className="alphabet text-center w-70cqw mx-auto text-bisque">
            <div className="alhabet-tittle font-frederica space-x-24 text-2xl pt-5">
                <h1 className='py-5'>Find Name Of Drink By First Letter</h1>
            </div>
            <button className='letter m-2cqw inline-block max-w-fit ' onClick={() => checkData("A")}>A</button>
